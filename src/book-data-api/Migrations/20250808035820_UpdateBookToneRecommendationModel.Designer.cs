...
namespace book_data_api.Migrations
{
    ...
    [Migration("20250808035820_UpdateBookToneRecommendationModel")]
    partial class UpdateBookToneRecommendationModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("book_data_api.Models.BookToneRecommendation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("BookToneRecommendations", t =>
                        {
            ...
            modelBuilder.Entity("book_data_api.Models.Bookshelf", b =>
                {
                    ...
                    b.Property<bool>("IsNonFictionGenre")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("book_data_api.Models.BookToneRecommendation", b =>
                {
                    b.HasOne("book_data_api.Models.Book", "Book")
                        .WithMany("BookToneRecommendations")
                        .HasForeignKey("BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("book_data_api.Models.Book", b =>
                {
                    ...
                    b.Navigation("BookToneRecommendations");
                });
