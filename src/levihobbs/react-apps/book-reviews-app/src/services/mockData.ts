...
export const mockBookReviews: BookReview[] = [
  {
    ...
    searchableString: "final eclipse matthew huddleston archway publishing epic-sf friends",
  ...
  },
  {
    ...
    searchableString: "1984 george orwell signet classics dystopian fiction sf-classics modern-classics",
    hasReviewContent: true,
  ...
  },
  {
    ...
    searchableString: "tenth of december george saunders random house short stories featured favorites modern-literary-fiction cyberpunk",
    hasReviewContent: true,
  ...
  },
  {
    ...
    searchableString: "the left hand of darkness: bbc radio 4 full-cast dramatisation ursula k. le guin bbc worldwide ltd. modern-classics sf-classics",
    hasReviewContent: true,
