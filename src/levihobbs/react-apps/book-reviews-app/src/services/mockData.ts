...
export const mockBookReviews: BookReview[] = [
  ...
  },
  {
    ...
    searchableString: "1984 george orwell signet classics dystopian fiction",
    hasReviewContent: true,
  ...
  },
  {
    ...
    searchableString: "tenth of december george saunders random house short stories",
    hasReviewContent: true,
    previewText: generatePreviewText(tenthOfDecemberReview),
    readingTimeMinutes: calculateReadingTime(tenthOfDecemberReview),
    coverImageId: null,
    bookshelves: [{ id: 219, name: "featured", displayName: "featured" }, { id: 196, name: "favorites", displayName: "favorites" },{ id: 221, name: "modern-literary-fiction", displayName: "modern-literary-fiction" }]
  },
  {
    id: 5,
    ...
    searchableString: "king arthur and the knights of the round table joshua e hanft abdo publishing arthurian legends",
    hasReviewContent: true,
  ...
  },
  {
    ...
    searchableString: "frog and toad are friends (frog and toad, #1) arnold lobel harpercollins favorites",
    hasReviewContent: true,
  ...
  },
  {
    ...
    searchableString: "religious explanation and scientific ideology (toronto studies in religion) jesse hobbs peter lang inc., international academic publishers friends philosophy 2025 reading list",
    hasReviewContent: true,
